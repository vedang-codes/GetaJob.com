...
<head>
	...
	<title>Recruiter Job Posting Page</title>
...
<body style="background-color:#f0f2f4">
    ...
    <div class="col-sm-8 col-md-6 col-lg-6">
      <form action="post.php" method="post" style = "text-align:center">
		...
		<input type="text" class="form-control" id="recruiter_name" name="recruiter_name" required placeholder="Recruiter name...">
		</div>
		<br>
		<div class="form-group">
		<label for="recruiter_email">Recruiter Email</label>
		<input type="email" class="form-control" id="recruiter_email" name="recruiter_email" required placeholder="Enter email..."> 
		</div>
		<br>
		<div class="form-group">
		...
		<input type="text" class="form-control" id="job_name" name="job_name" required placeholder="Job name...">
		</div>
		<br>
		<div class="form-group">
		<label for="job_id">Job ID</label>
		<input type="number" class="form-control" id="job_id" name="job_id" required placeholder="Job ID...">
		<?php isset($_POST['job_id']) ? $_POST['job_id'] : ''; ?>
		<?php if (!empty($error_msg)) { echo "<span class='error'>" . $error_msg . "</span>"; } ?>
		</div>
		<br>
		<div class="form-group">
		<label for="job_description">Job Description</label>
		<textarea type="text" rows="5" cols="80" id="job_description" name="job_description" required placeholder="Description...">
		</textarea>
		</div>
		<br>
		<button type="submit" class="btn btn-primary justify-content-center">Post</button>
		</form>
	</div>
	</div>
	</div>
