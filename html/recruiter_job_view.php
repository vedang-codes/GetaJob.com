...
<head>
	...
	<title>Recruiter Job View Page</title>
...
<body style="background-color: #f0f2f4">
	...
	<br>
	<br>
	<h2 style="text-align: center"><b>View Job Posting</b></h2>
	<br>
	
	<div class="container">
	<div class="row justify-content-center">
    <div class="col-sm-8 col-md-6 col-lg-6">
      <form action="recruiter_job_view.php" method="post" style = "text-align:center">
		<div class="form-group">
		<label for="job_id">Job ID</label>
		<input type="number" class="form-control" id="job_id" name="job_id" required placeholder="Job ID...">
		</div>
		<br>
		<button type="submit" class="btn btn-primary justify-content-center">View Job</button>
		</form>
	</div>
	</div>
	</div>
...
<?php
	...
	echo "<br><h4 style='color:red; padding-left:25px'><b>Job Postings</b></h4><br>";
	
	echo '<div class="table-responsive">';
	echo '<table class="table table-striped">';
	echo '<thead><tr><th>Job ID</th><th>Job Name</th><th>Recruiter Name</th><th>Recruiter Email<th>Company</th><th>Date Posted</th><th>Job Description</th></tr></thead>';
	echo '<tbody>';
	...
	while ($row = mysqli_fetch_assoc($result)) {
		...
		echo '<td>'.$row['recruiter_email'].'</td>';
