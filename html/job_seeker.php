...
<body style="background-color: #f0f2f4">
    ...
    <a class="navbar-brand" href="job_seeker.php"><h2><strong>GetaJob.com</strong></h2></a>
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="job_seeker.php"><b>Home</b></a>
        </li>
		<li class="nav-item">
			<?php
				session_start();
	...
	<br>
	<br>
	<h2 style="text-align:center"><b>View All Jobs</b></h2>
